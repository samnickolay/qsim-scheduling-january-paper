...
class BGSched (Component):
    ...
    def schedule_jobs_wcheckp_v2_sam_v1(self, preempt, fp_backf, fp_pre_bj, dsize_pnode, bw_temp_write, bw_temp_read,
       ...
       '''
        ...
        for eq_class in equiv:
            ...
            results = self.queue_jobs_sam_v1(active_jobs, job_length_type, now)
            ...
            if len(high_priority_jobs) != len(best_partition_dict_wcheckp):
                low_priority_jobs = self.remove_unpreemptable_low_priority_jobs(low_priority_jobs, job_length_type)
        ...
        for eq_class in equiv:
            ...
            if high_priority_jobs:
                ...
                try:
                    ...
                    best_partition_dict_wcheckp = ComponentProxy("system").find_job_location_wcheckp_sam_v1(
                        job_location_args, end_times, fp_backf, 0, job_length_type, checkp_t_internval, None)
    ...
    ###
    # samnickolay
    def queue_jobs_sam_v1(self, active_jobs, job_length_type, now):
        # realtime_jobs = []
        ...
        for j in active_jobs:
            if j.user == 'realtime':
                ...
                slowdown_threshold_simulation_time = (slowdown_threshold * runtime_temp) - runtime_temp + \
                                                     j.get('submittime')
        ...
        # This code will cause low_priority_jobs to block in presence of high_priority_jobs
        # if high_priority_jobs:
        #     low_priority_jobs = []
        ...
        # return realtime_jobs, active_jobs, slowdown_threshold_simulation_times, low_priority_queue_jobs, high_priority_queue_jobs
    ...
    def remove_unpreemptable_low_priority_jobs(self, low_priority_jobs, job_length_type=None):
