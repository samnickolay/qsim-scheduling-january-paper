...
if __name__ == "__main__":
    ...
    file_output_string = make_output_string(experiment_metrics)

    print(print_output_string)

    dir_name = './results/slowdown_results/'
    import os
    ...
    print 'Saving experiment results to file - ', outputfile_name
    ...
    with open(outputfile_name, "a") as outputfile:
        ...
        outputfile.write(file_output_string)
