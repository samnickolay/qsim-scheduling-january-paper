...
input_pickle_folder = '/home/samnickolay/simulation_pickled_data/'
output_folder = '/home/samnickolay/pricing_output/'
number_trials = 3
current_log = 'wk1.log'
...
def compute_offline_pricing_values(current_data_dict, baseline_data_dict, reimbursement_threshold):
    ...
    for jobid, job in jobs_metrics_current.iteritems():
        ...
        if core_hour_difference > core_hour_difference_threshold:
            ...
            #     job['extra_cost_core_hours'] = abs(performance_core_hours)
            # elif rt_method == 'even':
            #     job['extra_cost_core_hours'] = abs(core_hour_difference)
            # else:
            #     print('invalid rt_method')
            #     exit(-1)
    ...
    # for jobid, job in jobs_metrics_current.iteritems():
    #     if job['cost_type'] == 'reimbursed':
    #         print(job['reimbursed_core_hours'])
